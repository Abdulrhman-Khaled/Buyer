                                        ...
                                        SizedBox(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '${controller.cartProductModel[index].quantity!} X ${controller.cartProductModel[index].price!} L.E',
                                                style: TextStyle(
                                                    fontSize: 10.sp,
                                                    fontWeight: FontWeight.bold,
                                                    color: AppColors.orange),
                                ...
                                return Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      const Spacer(),
                                      Text(
                                        '${controller.cartProductModel[index].price!} L.E',
                                        style: GoogleFonts.rubik(
                                            fontSize: 12.sp,
                                            fontWeight: FontWeight.bold,
                                            color: AppColors.orange),
